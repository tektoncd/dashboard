...
describe('Log', () => {
  ...
  it('displays the scroll to top button when the virtualized list scroll is all the way down', async () => {
    ...
    await waitFor(() => {
      expect(container.querySelector('.scroll-to-top-btn')).not.toBeNull();
    });
    expect(container.querySelector('.scroll-to-bottom-btn')).toBeNull();
    fireEvent.click(container.querySelector('.scroll-to-top-btn'));
  ...
  it('displays both scroll buttons when the virtualized list scrolled is neither all the way up nor down', async () => {
    ...
    fireEvent.click(container.querySelector('.scroll-to-bottom-btn'));
