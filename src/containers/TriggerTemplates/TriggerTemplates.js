...
export /* istanbul ignore next */ class TriggerTemplates extends Component {
  ...
  render() {
    ...
    const initialHeaders = [
      {
        ...
        header: intl.formatMessage({
          id: 'dashboard.triggerTemplate.name',
          defaultMessage: 'Name'
        })
      },
      {
        key: 'date',
        header: intl.formatMessage({
          id: 'dashboard.triggerTemplate.date',
      ...
      },
      {
        key: 'namespace',
        header: intl.formatMessage({
          id: 'dashboard.triggerTemplate.namespace',
    ...
    return (
      <div className="triggerTemplates">
        {error && (
          <InlineNotification
            kind="error"
            ...
            iconDescription={intl.formatMessage({
              id: 'dashboard.triggerTemplate.clearNotification',
        ...
        <Table
          ...
          emptyTextAllNamespaces={intl.formatMessage({
            id: 'dashboard.triggerTemplate.emptyTableAllNamespaces',
            defaultMessage: 'No TriggerTemplates under any namespace.'
          })}
          emptyTextSelectedNamespace={intl.formatMessage(
            {
              id: 'dashboard.triggerTemplate.emptyTableSelectedNamespace',
              defaultMessage:
                'No TriggerTemplates under namespace {selectedNamespace}'
            },
            { selectedNamespace }
          )}
          isSortable
