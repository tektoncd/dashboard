...
export default () => createNamespacedReducer({ type: 'TriggerTemplate' });

export function getTriggerTemplates(state, namespace) {
  return getCollection(state, namespace);
}

export function getTriggerTemplate(state, name, namespace) {
